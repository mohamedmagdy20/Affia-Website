        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center mb-3">
                    <a href="{{route('admin.user.create')}}" class="btn btn-primary">اضافة المستخدمين <i
                            class="fa fa-plus"></i>
                    </a>
                </div>
                ...
                <table id="datatable-buttons" class="table dt-responsive nowrap w-100">
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>{{$item->phone}}</td>
                             <td>
                                <a href="{{route('admin.user.edit',$item->id)}}" class="btn btn-primary"><i class="fa fa-pen"></i></a>
