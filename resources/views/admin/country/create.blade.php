...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">اضافة مدن</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin') }}"></a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.category.index') }}">المدنات</a>
                    </li>
                    <li class="breadcrumb-item active">اضافة مدن</li>
                </ol>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form class="card-body" id="myForm" method="post" action="{{ route('admin.country.store') }}" enctype="multipart/form-data">
                @csrf
                <h4 class="card-title">اضافة مدن</h4>
                <div class="row mb-3">
                    <div class="col-md-12">
