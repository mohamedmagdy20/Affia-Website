...
<section class="flex flex-col md:flex-row  items-center mt-5 " >
    ...
    <div class="w-full h-100" >
        ...
        <h1 class="text-xl md:text-2xl font-bold leading-tight mt-12">انشيء حساب جديد</h1>
  
        <form class="mt-6" action="{{route('register.user')}}" method="POST" enctype="multipart/form-data">
            @csrf
              <div class="mb-3">
                <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="email">
                    الاسم
